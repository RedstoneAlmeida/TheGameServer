...
public class BinaryStream {
    ...
    public void putItemPacket(ItemCard card){
        this.putString(card.getName());
        this.putInt(card.getId());
        this.putShort(card.getCount());
    }

    public ItemCard getItemPacket(){
        String name = this.getString();
        int id = this.getInt();
        int count = this.getShort();
        ItemCard card = new ItemCard(id, count);
        card.setName(name);
        return card;
    }
